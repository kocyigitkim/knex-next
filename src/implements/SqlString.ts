...
function escapeId(val: Array<any> | string | object | number, forbidQualified: boolean = false) {
...
function escape(val: Array<any> | string | object | number, stringifyObjects: boolean = false, timeZone: string = 'local') {
    ...
    switch (typeof val) {
        ...
        case 'object':
            if (val instanceof Date) {
                ...
                return String((val as any).toSqlString());
...
function format(sql: string, values: any, stringifyObjects: boolean = false, timeZone: string = 'local') {
    if (values == null) {
        return sql;
    }
